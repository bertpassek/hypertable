 ...
 * </dl>
 */
public class CellInterval implements org.apache.thrift.TBase<CellInterval, CellInterval._Fields>, java.io.Serializable, Cloneable, Comparable<CellInterval> {
  ...
  public int compareTo(CellInterval other) {
    ...
    lastComparison = Boolean.valueOf(isSetEnd_column()).compareTo(other.isSetEnd_column());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetEnd_column()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.end_column, other.end_column);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
