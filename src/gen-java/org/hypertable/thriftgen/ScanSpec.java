...
public class ScanSpec implements org.apache.thrift.TBase<ScanSpec, ScanSpec._Fields>, java.io.Serializable, Cloneable, Comparable<ScanSpec> {
  ...
  private static final org.apache.thrift.protocol.TField AND_COLUMN_PREDICATES_FIELD_DESC = new org.apache.thrift.protocol.TField("and_column_predicates", org.apache.thrift.protocol.TType.BOOL, (short)19);
  ...
  public boolean and_column_predicates; // optional
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    AND_COLUMN_PREDICATES((short)19, "and_column_predicates");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 18: // DO_NOT_CACHE
          return DO_NOT_CACHE;
        case 19: // AND_COLUMN_PREDICATES
          return AND_COLUMN_PREDICATES;
        default:
          return null;
      }
    }
  ...
  static {
    ...
    tmpMap.put(_Fields.DO_NOT_CACHE, new org.apache.thrift.meta_data.FieldMetaData("do_not_cache", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.AND_COLUMN_PREDICATES, new org.apache.thrift.meta_data.FieldMetaData("and_column_predicates", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public ScanSpec(ScanSpec other) {
    ...
    this.and_column_predicates = other.and_column_predicates;
  }
  ...
  public boolean isAnd_column_predicates() {
    return this.and_column_predicates;
  }

  public ScanSpec setAnd_column_predicates(boolean and_column_predicates) {
    this.and_column_predicates = and_column_predicates;
    setAnd_column_predicatesIsSet(true);
    return this;
  }

  public void unsetAnd_column_predicates() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __AND_COLUMN_PREDICATES_ISSET_ID);
  }

  /** Returns true if field and_column_predicates is set (has been assigned a value) and false otherwise */
  public boolean isSetAnd_column_predicates() {
    return EncodingUtils.testBit(__isset_bitfield, __AND_COLUMN_PREDICATES_ISSET_ID);
  }

  public void setAnd_column_predicatesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __AND_COLUMN_PREDICATES_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case AND_COLUMN_PREDICATES:
      if (value == null) {
        unsetAnd_column_predicates();
      } else {
        setAnd_column_predicates((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case AND_COLUMN_PREDICATES:
      return Boolean.valueOf(isAnd_column_predicates());
  ...
  public boolean isSet(_Fields field) {
    ...
    case AND_COLUMN_PREDICATES:
      return isSetAnd_column_predicates();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(ScanSpec that) {
    ...
    boolean this_present_and_column_predicates = true && this.isSetAnd_column_predicates();
    boolean that_present_and_column_predicates = true && that.isSetAnd_column_predicates();
    if (this_present_and_column_predicates || that_present_and_column_predicates) {
      if (!(this_present_and_column_predicates && that_present_and_column_predicates))
        return false;
      if (this.and_column_predicates != that.and_column_predicates)
        return false;
    }
  ...
  public int compareTo(ScanSpec other) {
    ...
    lastComparison = Boolean.valueOf(isSetAnd_column_predicates()).compareTo(other.isSetAnd_column_predicates());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAnd_column_predicates()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.and_column_predicates, other.and_column_predicates);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    if (isSetAnd_column_predicates()) {
      if (!first) sb.append(", ");
      sb.append("and_column_predicates:");
      sb.append(this.and_column_predicates);
      first = false;
    }
    sb.append(")");
    return sb.toString();
  ...
  private static class ScanSpecStandardScheme extends StandardScheme<ScanSpec> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, ScanSpec struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 19: // AND_COLUMN_PREDICATES
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.and_column_predicates = iprot.readBool();
              struct.setAnd_column_predicatesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, ScanSpec struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAnd_column_predicates()) {
        oprot.writeFieldBegin(AND_COLUMN_PREDICATES_FIELD_DESC);
        oprot.writeBool(struct.and_column_predicates);
        oprot.writeFieldEnd();
      }
