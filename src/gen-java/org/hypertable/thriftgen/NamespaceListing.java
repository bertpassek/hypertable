 ...
 * </dl>
 */
public class NamespaceListing implements org.apache.thrift.TBase<NamespaceListing, NamespaceListing._Fields>, java.io.Serializable, Cloneable, Comparable<NamespaceListing> {
  ...
  static {
    schemes.put(StandardScheme.class, new NamespaceListingStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NamespaceListingTupleSchemeFactory());
  }
  ...
  public void unsetIs_namespace() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __IS_NAMESPACE_ISSET_ID);
  }

  /** Returns true if field is_namespace is set (has been assigned a value) and false otherwise */
  public boolean isSetIs_namespace() {
    return EncodingUtils.testBit(__isset_bitfield, __IS_NAMESPACE_ISSET_ID);
  }

  public void setIs_namespaceIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __IS_NAMESPACE_ISSET_ID, value);
  }
  ...
  public int compareTo(NamespaceListing other) {
    ...
    lastComparison = Boolean.valueOf(isSetIs_namespace()).compareTo(other.isSetIs_namespace());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIs_namespace()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.is_namespace, other.is_namespace);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class NamespaceListingStandardSchemeFactory implements SchemeFactory {
    public NamespaceListingStandardScheme getScheme() {
      return new NamespaceListingStandardScheme();
    }
  }

  private static class NamespaceListingStandardScheme extends StandardScheme<NamespaceListing> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NamespaceListing struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
          ...
          case 2: // IS_NAMESPACE
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.is_namespace = iprot.readBool();
              struct.setIs_namespaceIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NamespaceListing struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      oprot.writeBool(struct.is_namespace);
      oprot.writeFieldEnd();
  ...
  private static class NamespaceListingTupleSchemeFactory implements SchemeFactory {
    public NamespaceListingTupleScheme getScheme() {
      return new NamespaceListingTupleScheme();
    }
  }

  private static class NamespaceListingTupleScheme extends TupleScheme<NamespaceListing> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NamespaceListing struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NamespaceListing struct) throws org.apache.thrift.TException {
