 ...
 * </dl>
 */
public class HqlResult implements org.apache.thrift.TBase<HqlResult, HqlResult._Fields>, java.io.Serializable, Cloneable, Comparable<HqlResult> {
  ...
  static {
    schemes.put(StandardScheme.class, new HqlResultStandardSchemeFactory());
    schemes.put(TupleScheme.class, new HqlResultTupleSchemeFactory());
  }

  public List<String> results; // optional
  public List<org.hypertable.thriftgen.Cell> cells; // optional
  ...
  public HqlResult(HqlResult other) {
    ...
    if (other.isSetCells()) {
      List<org.hypertable.thriftgen.Cell> __this__cells = new ArrayList<org.hypertable.thriftgen.Cell>(other.cells.size());
  ...
  private static class HqlResultStandardSchemeFactory implements SchemeFactory {
    public HqlResultStandardScheme getScheme() {
      return new HqlResultStandardScheme();
    }
  }

  private static class HqlResultStandardScheme extends StandardScheme<HqlResult> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, HqlResult struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cells = new ArrayList<org.hypertable.thriftgen.Cell>(_list3.size);
                for (int _i4 = 0; _i4 < _list3.size; ++_i4)
                {
                  org.hypertable.thriftgen.Cell _elem5;
                  _elem5 = new org.hypertable.thriftgen.Cell();
                  _elem5.read(iprot);
                  struct.cells.add(_elem5);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HqlResult struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.results != null) {
        if (struct.isSetResults()) {
          oprot.writeFieldBegin(RESULTS_FIELD_DESC);
          {
            ...
            for (String _iter6 : struct.results)
            {
      ...
      if (struct.cells != null) {
        if (struct.isSetCells()) {
          oprot.writeFieldBegin(CELLS_FIELD_DESC);
          {
            ...
            for (org.hypertable.thriftgen.Cell _iter7 : struct.cells)
            {
              _iter7.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class HqlResultTupleSchemeFactory implements SchemeFactory {
    public HqlResultTupleScheme getScheme() {
      return new HqlResultTupleScheme();
    }
  }

  private static class HqlResultTupleScheme extends TupleScheme<HqlResult> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, HqlResult struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetResults()) {
        {
          ...
          for (String _iter8 : struct.results)
          {
      ...
      if (struct.isSetCells()) {
        {
          ...
          for (org.hypertable.thriftgen.Cell _iter9 : struct.cells)
          {
            _iter9.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, HqlResult struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(4);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list10 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
          struct.results = new ArrayList<String>(_list10.size);
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.cells = new ArrayList<org.hypertable.thriftgen.Cell>(_list13.size);
          for (int _i14 = 0; _i14 < _list13.size; ++_i14)
          {
            org.hypertable.thriftgen.Cell _elem15;
            _elem15 = new org.hypertable.thriftgen.Cell();
            _elem15.read(iprot);
            struct.cells.add(_elem15);
          }
        }
        struct.setCellsIsSet(true);
      }
